https://www.bilibili.com/video/BV1D54y1H7Bh/?p=7&vd_source=f089cad7f2e400622e91946932061cb9
...
![](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/202303061046173.png)

## ReentrantLock加锁和释放锁的底层
state 是 volatile 的，通过 CAS 进行加锁
![](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/202303061047682.png)

## 锁的互斥是如何实现
![](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/202303061048145.png)

**释放锁**的过程非常的简单就是将AQS内的state变量的值递减1，如果state值为0，则彻底释放锁，会将“加锁线程”变量也设置为null！

![](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/202303061049613.png)
![](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/202303061106876.png)
```java
...
waitStatus:是通过下一个节点给上一个节点(prev)设置的，代表是否有
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814112911.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113048.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113209.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113221.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113239.png)

AQS使用一个volatile的int类型的成员变量来表示同步状态，**<font color=red>通过内置的FIFO队列来完成资源获取的排队工作，通过CAS完成对State值的修改</font>**。
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113327.png)![img](https://p0.meituan.net/travelcube/3f1e1a44f5b7d77000ba4f9476189b2e32806.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113344.png)

为了帮助大家理解ReentrantLock和AQS之间方法的交互过程，以非公平锁为例，我们将加锁和解锁的交互流程单独拎出来强调一下，以便于对后续内容的理解。

![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113502.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113515.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113532.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113541.png)

从上图可以看出，跳出当前循环的条件是当“前置节点是头结点，且当前线程获取锁成功”。为了防止因死循环导致CPU资源被浪费，我们会判断前置节点的状态来决定是否要将当前线程挂起，具体挂起流程用流程图表示如下（shouldParkAfterFailedAcquire流程）：

![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113547.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113555.png)

当前节点是Head的后继节点。

![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113602.png)

当前节点不是Head的后继节点，也不是尾节点。

![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210814113608.png)
...
https://www.bilibili.com/video/BV15o4y1C7dD?p=2&spm_id_from=pageDriver

https://www.pdai.tech/md/java/thread/java-thread-x-lock-AbstractQueuedSynchronizer.html#aqs-%E6%A0%B8%E5%BF%83%E6%80%9D%E6%83%B3
