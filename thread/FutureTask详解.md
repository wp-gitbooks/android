...
> Future 表示了一个**任务的生命周期，是一个可取消的异步运算**，可以把它看作是一个异步操作的结果的占位符，它将在未来的某个时刻完成，并提供对其结果的访问。在并发包中许多异步任务类都继承自Future，其中最典型的就是 FutureTask。
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210729113445.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210729113552.png)
...
https://www.pdai.tech/md/java/thread/java-thread-x-juc-executor-FutureTask.html#future%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B

https://www.jianshu.com/p/d0be341748de
