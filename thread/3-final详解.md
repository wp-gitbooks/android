...
![](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210815113741.png)
...
# final基础使用 [[0-线程理论基础#关键字 volatile、synchronized 和 final]]
...
### 对象成员变量-使用 final 的限制条件和局限性 [[3-final详解#为什么final引用不能从构造函数中“溢出”]]
...
- 编译器会在final域写之后，构造函数return之前，插入一个**storestore屏障**。这个屏障可以禁止处理器把final域的写重排序到构造函数之外。
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210716174614.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210716174644.png)
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210716174705.png)
...
## final的实现原理  [[1-volatile#volatile部分有序性（如何保证有序性）]]
...
![img](https://cdn.jsdelivr.net/gh/wp3355168/Typora-Picgo-Gitee/img/20210716174729.png)
