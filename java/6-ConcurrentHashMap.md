...
# 带着BAT大厂的面试问题去理解 [[HashMap-ConcurrentHashMap详解]]
...
![img](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/20210729101253.png)
...
在JDK1.7之前，ConcurrentHashMap是通过分段锁机制来实现的，所以其最大并发度受Segment的个数限制。因此，在JDK1.8中，ConcurrentHashMap的实现原理摒弃了这种设计，而是选择了与HashMap类似的数组+链表+红黑树的方式实现，而**加锁则采用CAS和synchronized实现**。

## 数据结构

![img](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/20210729101403.png)
...
https://mp.weixin.qq.com/s/a_ATuWqpCIeVl_7TTIciVg

https://github.com/cosen1024/Java-Interview/blob/main/Java%E9%9B%86%E5%90%88/ConcurrentHashMap.md
