...
## 线索
事件、Handler处理、屏幕刷新、UI绘制


## 1 Input事件处理机制
https://juejin.cn/post/6956500920108580878#heading-0
### 1.1 系统机制分析
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170953879.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170955682.png)

    
      
#### 二、应用进程的处理过程：
当`Input`触控事件通过`socket`传递到`Settings`应用进程这边后，会唤醒应用的`UI`线程在`ViewRootImpl#deliverInputEvent`的流程中进行`Input`事件的具体分发与处理。具体的处理流程：
...
7.  **一次滑动过程的触控交互的`InputResponse`区域中一般会包含一个`Input`的`ACTION_DOWN`事件+多个`ACTION_MOVE`事件+一个`ACTION_UP`事件**，`Settings`应用界面中的相关`View`控件在收到多个`ACTION_MOVE`触控事件后，经过判断为用户手指滑动行为，**一般会调用`View#invalidate`等相关接口触发`UI`线程的绘制上帧更新画面的操作**，具体流程后文会继续详细分析。以上过程如下`Systrace`截图所示：  
   ![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170957521.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170958271.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170958363.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170958504.png)

  
理想情况下假设前一帧显示完成，后一帧数据就准备好了，屏幕开始读取下一帧内容进行显示，也就是开始读取上图中的后缓冲区的内容：  
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170959833.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170959031.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303170959929.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171000237.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171000442.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171001276.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171001735.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171002102.png)

硬件加速绘制之绘制命令树构建.png

  
硬件加速下的整个界面的`View`树的结构如下图所示：  
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171002217.png)

硬件绘制下的View树结构.png

  
最后从`Systrace`上看这个过程如下图所示：  
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171002069.png)
...
整个过程可以用如下流程图表示：  
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171003536.png)

RenderThread线程渲染流程.png

  
从`Systrace`上这个过程如下图所示：  
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171003240.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171004423.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171004386.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171005839.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171005726.png)

sf_Vsync1.png

  
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171005849.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171006460.png)
...
以上过程从`systrace`上看如下图所示：  
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171006114.png)
...
![](http://wupan.dns.army:5000/wupan/Typora-Picgo-Gitee/raw/branch/master/img/202303171007608.webp)
